...
* extension[code].value[x] from http://hl7.org/fhir/uv/application-feature/ValueSet/capability-feature-vs (extensible)
...
* extension[value].valueCodeableConcept from http://hl7.org/fhir/uv/application-feature/ValueSet/capability-feature-value-vs (extensible)