...
* extension[code].value[x] from http://www.hl7.org/fhir/uv/application-feature/ValueSet/capability-feature-vs (extensible)
...
* extension[value].valueCodeableConcept from http://www.hl7.org/fhir/uv/application-feature/ValueSet/capability-feature-value-vs (extensible)