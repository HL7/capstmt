...
* format[+] = #xml
* format[=] = #json
* rest.extension[feature].extension[code].valueCodeableConcept = http://hl7.org/fhir/uv/application-feature/CodeSystem/capability-feature-cs#versioning
* rest.extension[feature].extension[value].valueCodeableConcept = http://hl7.org/fhir/uv/application-feature/CodeSystem/capability-feature-value-cs#versioned
* rest.mode = #server